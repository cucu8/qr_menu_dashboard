...
const BASE_URL = isLocal ? 'http://localhost:5252' : 'http://31.57.33.170:8080';
...
const FRONTEND_URL = isLocal ? 'http://localhost:3000' : 'http://31.57.33.170'; // CANLI ORTAM QR DOMAINI BURAYA GELECEK
